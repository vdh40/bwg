# Тестовый проект для Black Wall Group

Данный проект является моей попыткой реализовать принципы чистой архитектуры.
В ходе работы над проектом я в большей степени концентрировался именно на построении архитектуры, на связях между слоями, поэтому проект лишен проработанной бизнес-логики, проверок типов, а также не решает всех поставленных задач.
