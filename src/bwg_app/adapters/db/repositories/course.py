...
from bwg_app.adapters.db.entities.course import CourseEntity
from bwg_app.adapters.db.entities.currency import CurrencyEntity
from bwg_app.application.dto.course import CourseDtoOut, CourseDtoIn
from bwg_app.application.dto.currency import CurrencyDtoOut
from bwg_app.application.protocols.repositories.course import CourseRepositoryProtocol
