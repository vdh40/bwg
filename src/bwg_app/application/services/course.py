...
from bwg_app.adapters.db.repositories.course import CourseRepository
...
from bwg_app.domain.models.course import Course
from bwg_app.domain.services.course import CourseDomainService
